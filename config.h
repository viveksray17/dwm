...
static const char *fonts[]          = { "JetBrains Mono Medium:size=11:antialias=true:autohint=true",
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,		        XK_q,	    spawn,		    SHCMD("/data/vivek/dwm/scripts/logout") },
    ...
    { 0,                            XK_Print,   spawn,		SHCMD("scrot -q 100 -p /data/vivek/Pictures/Screenshots/screenshot_%Y-%m-%d_%T.png;notify-send 'Scrot' 'Full-Screen Captured' --expire-time=2000") },
    { MODKEY,                       XK_Print,   spawn,		SHCMD("scrot -q 100 -u -p /data/vivek/Pictures/Screenshots/screenshot_%Y-%m-%d_%T.png;notify-send 'Scrot' 'Window Captured' --expire-time=2000") },
    { ShiftMask,                    XK_Print,   spawn,		SHCMD("scrot -q 100 -s -p /data/vivek/Pictures/Screenshots/screenshot_%Y-%m-%d_%T.png;notify-send 'Scrot' 'Area Captured' --expire-time=2000") },
    // Volume Control
